defmodule TaskBunny.Job do
  ...
  By default TaskBunny retries up to 10 times with at least five minutes between each attempt 
  for a failed job. You can change this by overriding `max_retry/0` and `retry_interval/1`.
